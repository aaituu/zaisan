//--------------------------------------------------
console.log("Platonus ALMAU js is loaded");
//--------------------------------------------------
...
(function(){
  ...
  xhr.open("GET", "https://almau.oes.kz/extension/platonus-status.php");
  xhr.send();
  ...
  document.addEventListener('mouseup', function(e) {
    ...
    window.location.href = "https://almau.oes.kz/internal_assignment?system=DEFAULT_PLATONUS&examName=" + encodeURIComponent(name) + "&url=" + encodeURIComponent(url) + "&backurl=" + encodeURIComponent(backurl);
    //--------------------
  });
