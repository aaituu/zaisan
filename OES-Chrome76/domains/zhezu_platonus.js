//--------------------------------------------------
console.log("Platonus ZHEZU js is loaded");
//--------------------------------------------------
...
(function(){
  ...
  xhr.open("GET", "https://tttu.oes.kz/extension/platonus-status.php");
  xhr.send();
  ...
  document.addEventListener('mouseup', function(e) {
    ...
    window.location.href = "https://tttu.oes.kz/internal_assignment?system=DEFAULT_PLATONUS&examName=" + encodeURIComponent(name) + "&url=" + encodeURIComponent(url) + "&backurl=" + encodeURIComponent(backurl);
    //--------------------
  });
