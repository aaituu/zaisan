//--------------------------------------------------
console.log("Platonus OSPANOV js is loaded");
//--------------------------------------------------
...
(function(){
  ...
  xhr.open("GET", "https://ospanov.oes.kz/extension/platonus-status.php");
  xhr.send();
  ...
  document.addEventListener('mouseup', function(e) {
    ...
    window.location.href = "https://ospanov.oes.kz/internal_assignment?system=DEFAULT_PLATONUS&examName=" + encodeURIComponent(name) + "&url=" + encodeURIComponent(url) + "&backurl=" + encodeURIComponent(backurl);
    //--------------------
  });
