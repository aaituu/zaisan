//--------------------------------------------------
console.log("Platonus AUIMVD js is loaded");
//--------------------------------------------------
...
(function(){
  ...
  xhr.open("GET", "https://auimvd.oes.kz/extension/platonus-status.php");
  xhr.send();
  ...
  document.addEventListener('mouseup', function(e) {
    ...
    window.location.href = "https://auimvd.oes.kz/internal_assignment?system=DEFAULT_PLATONUS&examName=" + encodeURIComponent(name) + "&url=" + encodeURIComponent(url) + "&backurl=" + encodeURIComponent(backurl);
    //--------------------
  });
